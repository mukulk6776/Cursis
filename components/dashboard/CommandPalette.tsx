...
export default function CommandPalette() {
  ...
  const actions: CommandAction[] = [
    ...
    },
    {
      ...
      group: 'Navigate',
      icon: 'U',
      text: 'Go to Team Directory & Org Chart',
    ...
    },
    {
      ...
      group: 'Navigate',
      icon: 'M',
      text: 'Go to Meetings (Google Meet / Zoom)',
    ...
    },
    {
      ...
      group: 'Navigate',
      icon: 'W',
      text: 'Go to Workspace & Client CRM',
    ...
    },
    {
      ...
      group: 'Navigate',
      icon: 'I',
      text: 'Go to Integrations & Webhooks',
